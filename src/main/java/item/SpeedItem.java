...
public class SpeedItem extends Item {
    ...
    public void getImage() {
        try {
            normal = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("Item/SpeedItem.png")));
        } catch (IOException e) {
