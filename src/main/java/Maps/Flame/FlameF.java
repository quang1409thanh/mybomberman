...
public class FlameF extends Flame {

    public FlameF(PanelGame gp, String type) {
        this.panel = gp;
        getImage(type);
    }
    ...
    public void getImage(String type) {
        try {
            if (type.equals("advanced_2") || type.equals("normal")) {
                flame1 = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("bomb/a1.png")));
                flame2 = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("bomb/a2.png")));
                flame3 = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("bomb/a3.png")));
            } else {
